...
#define CHECK_SD_CARD_RET 		if (BSP_SD_IsDetected() != SD_PRESENT) return
#define CHECK_SD_CARD_RETVAL 	if (BSP_SD_IsDetected() != SD_PRESENT) return 0
...
char zucca_path[FILE_NAME_SIZE];

int32_t buffer2sd[2][BUFFER_SIZE];
